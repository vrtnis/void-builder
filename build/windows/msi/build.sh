...
if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  PRODUCT_NAME="Aide - Insiders"
  PRODUCT_CODE="AideInsiders"
...
if [[ -z "${1}" ]]; then
	OUTPUT_BASE_FILENAME="Aide-${VSCODE_ARCH}-${RELEASE_VERSION}"
else
	OUTPUT_BASE_FILENAME="Aide-${VSCODE_ARCH}-${1}-${RELEASE_VERSION}"
fi
