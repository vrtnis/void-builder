...
export VSCODE_CLI_UPDATE_ENDPOINT="https://raw.githubusercontent.com/voideditor/versions/refs/heads/master"

if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  export VSCODE_CLI_DOWNLOAD_ENDPOINT="https://github.com/voideditor/void-insiders/releases"
else
  export VSCODE_CLI_DOWNLOAD_ENDPOINT="https://github.com/void/void/releases"
fi
